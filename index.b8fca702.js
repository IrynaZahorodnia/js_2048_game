...
document.addEventListener("keydown", (keyEvent)=>{
    if (game.getStatus() !== Game.gameStatus.playing) return;
    let canMove = false;
    switch(keyEvent.key){
        case "ArrowLeft":
    ...
    game.fillFreeCell();
    game.updateBorder();
    if (game.getStatus() === Game.gameStatus.win) winMessage.classList.remove("hidden");
    if (game.getStatus() === Game.gameStatus.lose) loseMessage.classList.remove("hidden");
});

},{"789b00406e138236":"eIbh2"}],"eIbh2":[function(require,module,exports) {
"use strict";
const { getEmptyCells, getRandomTwoOrFour } = require("8bccfd4f19cc959f");
const SIZE = 4;
class Game {
    static gameStatus = {
        idle: "idle",
    ...
    transpose() {
        for(let x = 0; x < SIZE; x++)for(let y = 0; y < x; y++)this.swap(x, y);
    }
    moveUp() {
        this.transpose();
    ...
    checkLose() {
        ...
        if (!emptyCells.length) {
            for(let x = 0; x < SIZE; x++)for(let y = 0; y < SIZE - 1; y++){
    ...
    updateBorder() {
        ...
        this.state.forEach((row, rowIndex)=>{
            row.forEach((cell, cellIndex)=>{
                ...
                if (cell === 2048) this.status = Game.gameStatus.win;
            });
        });
        this.checkLose();
    }
...
},{"8bccfd4f19cc959f":"5sJZc"}],"5sJZc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getRandomTwoOrFour", ()=>getRandomTwoOrFour);
parcelHelpers.export(exports, "getEmptyCells", ()=>getEmptyCells);
